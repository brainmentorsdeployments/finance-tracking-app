...
import { genericValidation } from "../../../shared/validation.js";
...
function bindEvents(){
    ...
    document.querySelector('#amount').addEventListener('keyup', validateAmount);
}

function validateAmount(event){
    console.log(event.target.value);
    genericValidation(event.target.value, /^[0-9]{5,10}$/, 'Invalid Amount','amount-error', '<i class="fa-solid fa-check"></i>');
    // const regex = /^[0-9]{5,10}$/;
    // if(regex.test(event.target.value)){
    //     document.querySelector('#amount-error').innerText = '';
    //     document.querySelector('#amount-error').innerHTML = '<i class="fa-solid fa-check"></i>';
    // }
    // else{
    //     document.querySelector('#amount-error').innerHTML ='';
    //     document.querySelector('#amount-error').innerText = 'Invalid Amount';
    // }
}
